...
# -*- coding: utf-8 -*-
"""
Created on Fri Sep 15 08:20:07 2023
...
model = keras.Sequential([
    ...
    layers.Dense(1024, activation='relu', name='1_hidden_layer'),
    layers.Dropout(rate=0.3),
    layers.Dense(1024, activation='relu', name='2_hidden_layer'),
    layers.Dense(1024, activation='relu', name='3_hidden_layer'),
    layers.Dense(10, activation='softmax', name='output_layer')  # Az osztályok száma 10, ahogy a one-hot encodingban is
])
